...
The interesting implications of this setup is that the microphone itself is very small, and also very cheap, costing only a few dollars\cite{butikken}. 
...
The small microphone also opens for the possibility to hide the whole setup inside the casing of a desktop computer or a server, thus possibly making side channel attacks easier due to a better signal-to-noise ration due to the reduced distance between the source and the microphone.
