...
In our case this means that we need to know what happening on in the CPU for the duration of our recordings.
...
The CPU operation will loop are the MUL, ADD and NOP microinstructions as well as memory access with forced L1 and L2 cache miss.
...
If cache hit occurs in the L1 or L2 cache, the lookup time is much lower than if the value is read from the RAM\todo{Use acronym?}.
