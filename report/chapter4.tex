...
For the Raspberry Pi, we use the sysbench~\cite{url:sysbench_wiki} benchmarking tool to generate \gls{CPU} load.
...
We use the GnuPG 1.4.15 library as it contains the vulnerability suggested in~\cite[Sec.~9.1]{DBLP:conf/crypto/GenkinST14}. 
