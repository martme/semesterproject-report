...
\begin{figure}
    ...
    %                 %title={Something},
    %                 ]
    %                 \addplot table [x=a, y=b, col sep=comma] {data/dummy.csv};
    %                 \addlegendentry{Case 1}

    %                 \addplot table [x=a, y=c, col sep=comma] {data/dummy.csv};
    ...
    %\resizebox{\linewidth}{!}{
        \begin{tikzpicture}
            ...
            \addplot table [ mark=none, y=p, x=D430, col sep=comma] {data/mem-benchmark-cdf.csv};
