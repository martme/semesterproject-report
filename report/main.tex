...
\title{Analysis of Acoustic Emanations From Computer Systems} % The title of your assignement; NB use \newlinetitle to start a newline
...
\include{appendix_experiment_plan}
\include{appendix_code}
\include{appendix_mem_benchmark}
