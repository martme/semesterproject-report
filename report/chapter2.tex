...
The acoustic side channel has been known as a potential attack vector for mechanical systems since the second world war, where phone taps were used to find the keys of mechanical cipher machines, as the code was renewed every day, producing a mechanical click sound which enabled an eavesdropper to derive yesterdays key~\cite{wright1988spycatcher}
