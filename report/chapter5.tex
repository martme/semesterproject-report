...
%================================
The~\autoref{fig:D430-ekkofritt-bk-cpuload-eps-1} is the result from the running CPU load, described in~\autoref{chp4:sec:cpu_load}, on the Dell 430 in the anechoic chamber. 
\begin{figure}[ht]
    \centering
